...
public:
    ...
    void exec_base(int my_num, int other_player, string my_ip, string other_player_ip, int my_port, int other_player_port, string other_player_sae, string ksid, int index, vector<unsigned char> psk, bool new_receiver_inputs=true);

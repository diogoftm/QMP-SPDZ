...
void BaseOT::exec_base(int my_num, int other_player, bool new_receiver_inputs)
{
    ...
    struct timeval computationstart_1, computationend_1, computationstart_2, computationend_2, computationstart_3, computationend_3;
	...
	double computationtime_1 = (double)(computationend_1.tv_sec - computationstart_1.tv_sec) + (double)(computationend_1.tv_usec - computationstart_1.tv_usec) / 1000000.0;
	double computationtime_2 = (double)(computationend_2.tv_sec - computationstart_2.tv_sec) + (double)(computationend_2.tv_usec - computationstart_2.tv_usec) / 1000000.0;
	double computationtime_3 = (double)(computationend_3.tv_sec - computationstart_3.tv_sec) + (double)(computationend_3.tv_usec - computationstart_3.tv_usec) / 1000000.0;
	printf("Computation: %f seconds\n", computationtime_1 + computationtime_2 + computationtime_3);
#endif
    }
